...
public class Van implements Veiculo {
   ...
   private float precoDia;
    ...
    public Van(String placa, String marca, String modelo, int km, float precoDia) throws PlacaExistenteException {
        setPlaca(placa);
        this.marca = marca;
        this.modelo = modelo;
        this.km = km;
    ...
    public String toString() {
        return "Van{" + "placa=" + placa + ", marca=" + marca + ", modelo=" + modelo + ", km=" + km + ", precoDia=" + precoDia + '}';
    }
